...
int main(void) {
    ...
    OLED_ShowChinese(32, 6, AIR, 2);//质
    OLED_ShowChinese(48, 6, AIR, 3);//量
...
//        printf("temp:%d ℃,\rhum:%d %% ,\r,Light:%d\r\n,co2:%lu ppd\r\n", temp, hum,BH1750_Get_Value(), CO2Data);
        ...
        OLED_ShowNum(48,2,hum,2,16);//湿度
        OLED_ShowNum(80,4,BH1750_Get_Value(),3,16);//光照强度
        OLED_ShowNum(80,6,CO2Data,3,16);//CO2浓度
//        printf("Hello World!\r\n");
        delay_us(1000);
        /* USER CODE END WHILE */
